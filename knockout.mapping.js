...
(function(e) {
    ...
    function y(b, c) {
        ...
        if ("array" === f.getType(b[d]) && "array" === f.getType(c[d])) {
            a = b;
        ...
        if (t) {
            ...
            Q(c, function(d) {
                ...
                if (-1 == e.utils.arrayIndexOf(a.ignore, f))
                    if (-1 != e.utils.arrayIndexOf(a.copy, f)) b[d] = c[d];
                    else
                if ("object" != typeof c[d] && "array" != typeof c[d] && 0 < a.observe.length && -1 == e.utils.arrayIndexOf(a.observe, f)) b[d] = c[d], a.copiedProperties[f] = !0;
                else {
                    var g = I.get(c[d]),
    ...
    f.defaultOptions = function() {
        if (0 < arguments.length) j = arguments[0];
        else return j
    };
